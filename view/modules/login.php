...
<head>
	...
	<link rel="icon" type="image/png" href="view/images/login/icons/favicon.ico" />

	<link rel="stylesheet" type="text/css" href="view/vendor/login/bootstrap/css/bootstrap.min.css">

	<link rel="stylesheet" type="text/css" href="view/fonts/login/font-awesome-4.7.0/css/font-awesome.min.css">

	<link rel="stylesheet" type="text/css" href="view/fonts/login/iconic/css/material-design-iconic-font.min.css">

	<link rel="stylesheet" type="text/css" href="view/vendor/login/animate/animate.css">

	<link rel="stylesheet" type="text/css" href="view/vendor/login/css-hamburgers/hamburgers.min.css">

	<link rel="stylesheet" type="text/css" href="view/vendor/login/animsition/css/animsition.min.css">

	<link rel="stylesheet" type="text/css" href="view/vendor/login/select2/select2.min.css">

	<link rel="stylesheet" type="text/css" href="view/vendor/login/daterangepicker/daterangepicker.css">

	<link rel="stylesheet" type="text/css" href="view/css/login/util.css">
	<link rel="stylesheet" type="text/css" href="view/css/login/main.css">
...
<body>
	...
	<script src="view/vendor/login/jquery/jquery-3.2.1.min.js"></script>

	<script src="view/vendor/login/animsition/js/animsition.min.js"></script>

	<script src="view/vendor/login/bootstrap/js/popper.js"></script>
	<script src="view/vendor/login/bootstrap/js/bootstrap.min.js"></script>

	<script src="view/vendor/login/select2/select2.min.js"></script>

	<script src="view/vendor/login/daterangepicker/moment.min.js"></script>
	<script src="view/vendor/login/daterangepicker/daterangepicker.js"></script>

	<script src="view/vendor/login/countdowntime/countdowntime.js"></script>

	<script src="view/js/login/main.js"></script>
