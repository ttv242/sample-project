    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 element-animate ">
                <a href="#" class="img-bg" style="background-image: url('view/images/img_2.jpg')">
                    <div class="text">
            ...
            <div class="col-md-4 element-animate ">
                <a href="#" class="img-bg" style="background-image: url('view/images/img_1.jpg')">
                    <div class="text">
                        <span class="icon ion-ios-location"></span>
            ...
            <div class="col-md-4 element-animate ">
                <a href="#" class="img-bg last" style="background-image: url('view/images/img_3.jpg')">
                    <div class="text">
                        <span class="icon ion-ios-location"></span>
        ...
        <div class="row">
            <div class="col-md-4 element-animate ">
                <a href="#" class="img-bg" style="background-image: url('view/images/img_4.jpg')">
                    <div class="text">
                        <span class="icon ion-ios-location"></span>
            ...
            <div class="col-md-4 element-animate ">
                <a href="#" class="img-bg" style="background-image: url('view/images/img_5.jpg')">
                    <div class="text">
                        <span class="icon ion-ios-location"></span>
            ...
            <div class="col-md-4 element-animate ">
                <a href="#" class="img-bg last" style="background-image: url('view/images/img_6.jpg')">
                    <div class="text">
                        <span class="icon ion-ios-location"></span>
    ...
    <div class="container">
        ...
        <div class="row top-destination">
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <a href="#" class="place">
                    <img src="view/images/img_1.jpg" alt="Image placeholder">
                    <h2>Trogir, Croatia</h2>
                    <p>Visit This Place</p>
                </a>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <a href="#" class="place">
                    <img src="view/images/img_2.jpg" alt="Image placeholder">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <a href="#" class="place">
                    <img src="view/images/img_3.jpg" alt="Image placeholder">
                    <h2>Desert, Morocco</h2>
                    <p>Visit This Place</p>
                </a>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <a href="#" class="place">
                    <img src="view/images/img_4.jpg" alt="Image placeholder">
                    <h2>Taj Mahal, India</h2>
                    <p>Visit This Place</p>
                </a>
            </div>
