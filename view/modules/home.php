            ...
            <div class="col-md-8 text-center">
                ...
                <form class="form-inline element-animate" id="search-form">
                    ...
                    <input type="text" class="form-control form-control-block search-input" id="autocomplete"
                        placeholder="Search Location with Google Search API" onFocus="geolocate()">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 pr-5">
                ...
                <div class="mb-3">
                    <a href="#" class="btn btn-primary custom-prev mr-2 mb-2"><span
                            class="ion-android-arrow-back"></span></a>
                    <a href="#" class="btn btn-primary custom-next mr-2 mb-2"><span
