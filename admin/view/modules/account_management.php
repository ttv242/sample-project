        ...
        <div class="row">
            <div class="col-xl-8 col-sm-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body px-0 overflow-auto">
                        <h4 class="card-title pl-4">Tất cả tài khoản</h4>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="table-user-name ml-3">
                                                        <p class="mb-0 font-weight-medium" value="' . $item['id'] . '">' . $item['user'] . '</p>
                                                        <small value="' . $item['id'] . '">' . $item['username'] . '</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td value="' . $item['id'] . '">' . $item['pass'] . '</td>
                                            <td>
                                                <div class="badge badge-inverse-success" value="' . $item['id'] . '">' . $item['role'] . '</div>
                                            </td>
                                            <td>
                                                <a href="index.php?action=account_management&id=' . $item['id'] . '"><span class="mdi mdi-table-edit"></span></a> | 
                                                <a href="index.php?action=delete_account&id=' . $item['id'] . '"><span class="mdi mdi-delete-forever"></span></a>
                                            </td>
                                        </tr>';
                                        }
                                    }
                        ...
                        <!-- <a class="text-black mt-3 d-block pl-4" href="#">
                            <span class="font-weight-medium h6">Xem tất cả</span>
            ...
            if (isset($_GET['id'])) {
                ...
                <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
                    <div class="card">
                        <form class="card-body" action="index.php?action=update_account" method="POST">
                            <h4 class="card-title"> Cập nhật tài khoản </h4><span>
                                <?= $kqone[0]['username'] ?>
                            </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="id" value="<?= $kqone[0]['id'] ?>" />
                                <input type="text" class="form-control" placeholder="User" aria-label="Username" name="user"
                                    value="<?= $kqone[0]['user'] ?>" />
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Quyền truy cập</label>
                                <div class="col-sm-4">
                                        ...
                                        if ($kqone[0]['role'] == 1) {
                                            ...
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="optionsRadios"
                                                    id="optionsRadios1" value="up" checked /> Admin </label>
                                            <?php
                                        } else {
                                            ?>
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="optionsRadios"
                                                    id="optionsRadios1" value="up" /> Admin </label>
                                        <?php
                                        }
                                        ?>
                                    </div>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-check">
                                        ...
                                        if ($kqone[0]['role'] == 0) {
                                            ...
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="optionsRadios"
                                                    id="optionsRadios2" value="down" checked /> User </label>
                                            <?php
                                        } else {
                                            ?>
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="optionsRadios"
                                                    id="optionsRadios2" value="down" /> User </label>
                                        <?php
                                        }
                                        ?>
                                    </div>
