...
<!-- Mirrored from themewagon.github.io/Breeze-Free-Bootstrap-Admin-Template/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Apr 2023 15:53:43 GMT -->
<!-- Added by HTTrack -->
    ...
    <div class="container-scroller">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
                <a class="sidebar-brand brand-logo" href="index.php"><img src="view/images/logo.svg"
                        alt="logo" /></a>
            ...
            <ul class="nav">
                <li class="nav-item nav-profile">
                    <a href="index.php?action=account_information" class="nav-link">
                        <div class="nav-profile-image">
                            <img src="view/images/faces/face1.jpg" alt="profile" />
                        ...
                        <span class="badge badge-danger text-white ml-0 rounded">0</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?action=catalog_management">
                        <i class="mdi mdi-wunderlist menu-icon"></i>
                        <span class="menu-title">Quản lý danh mục</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php?action=product_management">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?action=buttons">Buttons</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?action=dropdowns">Dropdowns</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?action=typography">Typography</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php?action=mdi">
                        <i class="mdi mdi-contacts menu-icon"></i>
                        <span class="menu-title">Icons</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php?action=basic_elements">
                        <i class="mdi mdi-format-list-bulleted menu-icon"></i>
                        <span class="menu-title">Forms</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php?action=chartjs">
                        <i class="mdi mdi-chart-bar menu-icon"></i>
                        <span class="menu-title">Charts</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php?action=basic-table">
                ...
                <li class="nav-item">
                    <a class="nav-link"
                        href="https://www.bootstrapdash.com/demo/breeze-free/documentation/documentation.php">
                ...
                <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
                    ...
                    <ul class="navbar-nav navbar-nav-right ml-lg-auto">
                        ...
                        <li class="nav-item nav-profile dropdown border-0">
                            ...
                            if (isset($_SESSION['username']) && ($_SESSION['username'])) {
                                echo '
                            <a class="nav-link dropdown-toggle" id="profileDropdown" href="index.php?action=account_information" data-toggle="dropdown">
