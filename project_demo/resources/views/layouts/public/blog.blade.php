...
<section class="slider-wrap site-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 element-animate ">
                <a href="#" class="img-bg" style="background-image: url('{{asset('images/img_4.jpg')}}')">
                    <div class="text">
                        <span class="icon ion-images"></span>
            ...
            <div class="col-md-4 element-animate ">
                <a href="#" class="img-bg" style="background-image: url('{{asset('images/img_5.jpg')}}')">
                    <div class="text">
                        <span class="icon ion-document"></span>
            ...
            <div class="col-md-4 element-animate ">
                <a href="#" class="img-bg last" style="background-image: url('{{asset('images/img_6.jpg')}}')">
                    <div class="text">
                        <span class="icon ion-document"></span>
